...
この順序モデルは [MTP Playlist Skill](/ja/skills/mtp-playlist/) の基本形式です。  
20 個のスロットが曲の配置先になり、各曲はその位置で担う役割に沿って選曲されます。
...
- [MTP Playlist Skill](/ja/skills/mtp-playlist/) で、20 ノードのシーケンスに沿った音楽プレイリストを作成する
